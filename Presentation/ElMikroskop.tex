...
\frame{
	...
	\begin{columns}
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.67\textheight]{img/Titan_Krios_University_of_Leeds.jpg}
		...
		\begin{column}{.5\textwidth}
			\begin{figure}
				\adjincludegraphics[height=.67\textheight]{img/CroV_TEM.jpg}
				\caption*{Snímky virů z cryo-EM mikroskopu.\footnote[frame]{Zdroj: \href{https://doi.org/10.1038/s41598-017-05824-w}{Nature}}}
			\end{figure}
		\end{column}
	\end{columns}
	\vfill
